...
const main = async () => {
  try {
    ...
    if (!excelFilePath) {
      console.log('Usage: node import-events-from-excel.js <path-to-excel-file>');
      console.log('Example: node import-events-from-excel.js "C:\\Users\\ALEX\\thinkevebn\\Think-Events\\event list .xlsx"');
      process.exit(1);
    }
    
    console.log('🚀 Starting events import from Excel...');
    await importEventsFromExcel(excelFilePath);
